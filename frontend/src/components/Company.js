      ...
      {isEditing ? (
        <>
          ...
          <td style={{ textAlign: "right" }}>
            <button className="button red" onClick={handleUpdate} style={{ marginRight: "6px" }}>Save</button>
        ...
        <>
          ...
          <td style={{ textAlign: "right" }}>
            <button className="button red" onClick={() => setIsEditing(true)} style={{ marginRight: "6px" }}>Edit</button>
